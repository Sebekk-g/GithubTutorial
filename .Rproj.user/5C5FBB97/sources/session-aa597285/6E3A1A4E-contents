...
#par parametry, old par stare parametry żeby je przywrócić 
#par, mar parametry wykresu 
#las = 1 etykiety osi poziomo 
#axis 2, at dodaj os y i znaczniki na tej osi 
#mtext dodaje opis osi 
#expresion zamieneia wytażenie na ułamek 
#frac ułamek przed przecinkiem to co ma być na kreską,
#po przecinku to co pod kreską
#
